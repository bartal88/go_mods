...
const randomStringSource = "abcdefghijklmopqrstuwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_+"

// Tools is the type used to instantiate this module.
// Any variable of this type will have access
// to all methods within the reciever *Tools
type Tools struct {
	MaxFileSize int64
...
func (t *Tools) UploadFiles(r *http.Request, uploadDir string, rename ...bool) ([]*UploadedFile, error) {
	...
	if err != nil {
		return nil, error.New("the uploaded file is too big")
	}
